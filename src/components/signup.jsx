...
export default function Signup() {
  ...
  return (
    <div class="border-solid border-2 border-teal-600 h-screen bg-gradient-to-r from-teal-800 to-teal-100">
      <div class="md:bg-color : bg-teal-600 (green) max-w-4xl m-auto mt-8 rounded-xl">
        <div class="md:flex items-center justify-center content-center text-center border-solid border-2 border-black h-[600px] max-w-4xl">
          <div>
